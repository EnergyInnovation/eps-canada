...
PotentialPolicies = (
	...
	(True,"Additional Minimum Required EV Sales Percentage[passenger,LDVs]","Electric Vehicle Sales Mandate - Passenger LDVs",[0,0.761],"EV Sales Mandate"),
	(True,"Additional Minimum Required EV Sales Percentage[passenger,HDVs]","Electric Vehicle Sales Mandate - Passenger HDVs",[0,0.761],"EV Sales Mandate"),
	(True,"Additional Minimum Required EV Sales Percentage[freight,HDVs]","Electric Vehicle Sales Mandate - Freight HDVs",[0,0.761],"EV Sales Mandate"),
	(True,"Additional Minimum Required EV Sales Percentage[passenger,motorbikes]","Electric Vehicle Sales Mandate - Passenger Motorbikes",[0,0.761],"EV Sales Mandate"),
	...
	(True,"Additional LCFS Percentage","Low Carbon Fuel Standard",[0,0.366],"Low Carbon Fuel Standard"),
	...
	(True,"Reduction in E Use Allowed by Component Eff Std[heating,urban residential]","Building Energy Efficiency Standards - Urban Residential Heating",[0,0.96],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[cooling and ventilation,urban residential]","Building Energy Efficiency Standards - Urban Residential Cooling and Ventilation",[0,0.96],"Building Energy Efficiency Standards"),
	(False,"Reduction in E Use Allowed by Component Eff Std[envelope,urban residential]","Building Energy Efficiency Standards - Urban Residential Envelope",[0,1],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[lighting,urban residential]","Building Energy Efficiency Standards - Urban Residential Lighting",[0,0.96],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[appliances,urban residential]","Building Energy Efficiency Standards - Urban Residential Appliances",[0,0.96],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[other component,urban residential]","Building Energy Efficiency Standards - Urban Residential Other Components",[0,0.96],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[heating,rural residential]","Building Energy Efficiency Standards - Rural Residential Heating",[0,0.96],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[cooling and ventilation,rural residential]","Building Energy Efficiency Standards - Rural Residential Cooling and Ventilation",[0,0.96],"Building Energy Efficiency Standards"),
	(False,"Reduction in E Use Allowed by Component Eff Std[envelope,rural residential]","Building Energy Efficiency Standards - Rural Residential Envelope",[0,1],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[lighting,rural residential]","Building Energy Efficiency Standards - Rural Residential Lighting",[0,0.96],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[appliances,rural residential]","Building Energy Efficiency Standards - Rural Residential Appliances",[0,0.96],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[other component,rural residential]","Building Energy Efficiency Standards - Rural Residential Other Components",[0,0.96],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[heating,commercial]","Building Energy Efficiency Standards - Commercial Heating",[0,0.89],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[cooling and ventilation,commercial]","Building Energy Efficiency Standards - Commercial Cooling and Ventilation",[0,0.89],"Building Energy Efficiency Standards"),
	...
	(True,"Reduction in E Use Allowed by Component Eff Std[lighting,commercial]","Building Energy Efficiency Standards - Commercial Lighting",[0,0.89],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[appliances,commercial]","Building Energy Efficiency Standards - Commercial Appliances",[0,0.89],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[other component,commercial]","Building Energy Efficiency Standards - Commercial Other Components",[0,0.89],"Building Energy Efficiency Standards"),
	...
	(True,"Boolean Use Non BAU Mandated Capacity Construction Schedule","Non BAU Mandated Capacity Construction",[0,1],"Non BAU Mandated Capacity Construction"),
	...
	(True,"Annual Additional Capacity Retired due to Early Retirement Policy[hard coal es]","Early Retirement of Power Plants - Hard Coal",[0,400],"Early Retirement of Power Plants"),
	...
	(True,"Fraction of Hard Coal Use Converted to Other Fuels","Electrify Hard Coal Processes",[0,0.9],"Industrial Electrification"),
	(True,"Fraction of Natural Gas Use Converted to Other Fuels","Electrify NG Processes",[0,0.282],"Industrial Electrification"),
	(True,"Fraction of Methane Capture Opportunities Achieved","Methane Capture",[0,1],"Methane Capture and Destruction"),
	...
	(True,"Carbon Tax[transportation sector]","Carbon Tax - Transportation Sector",[0,243],"Carbon Tax"),
	(True,"Carbon Tax[electricity sector]","Carbon Tax - Electricity Sector",[0,243],"Carbon Tax"),
	(True,"Carbon Tax[residential buildings sector]","Carbon Tax - Residential Bldg Sector",[0,243],"Carbon Tax"),
	(True,"Carbon Tax[commercial buildings sector]","Carbon Tax - Commercial Bldg Sector",[0,243],"Carbon Tax"),
	(True,"Carbon Tax[industry sector]","Carbon Tax - Industry Sector",[0,243],"Carbon Tax"),
	(True,"Percent Reduction in BAU Subsidies[hard coal]","End Existing Subsidies - Hard Coal",[0,1],"End Existing Subsidies"),
	(True,"Percent Reduction in BAU Subsidies[natural gas]","End Existing Subsidies - Natural Gas",[0,1],"End Existing Subsidies"),
	...
	(True,"Percent Reduction in BAU Subsidies[petroleum gasoline]","End Existing Subsidies - Petroleum Gasoline",[0,1],"End Existing Subsidies"),
	(True,"Percent Reduction in BAU Subsidies[petroleum diesel]","End Existing Subsidies - Petroleum Diesel",[0,1],"End Existing Subsidies"),
	(True,"Percent Reduction in BAU Subsidies[jet fuel]","End Existing Subsidies - Jet Fuel",[0,1],"End Existing Subsidies"),
